...
> We consider this exercise ''obsolete'', in the sense that there is a new variant which is specialized on network data analysis. Please, go to [TSTAT Trace Analysis with Pig][tstat] for this exercise.
